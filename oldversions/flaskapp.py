...
def process():
    ...
    ticker = input_data
    try:
     return f'You entered: {input_data}, {calcstock(ticker)}'
    except:
        return f'Invalid stock!'
...
def calcstock(ticker):
  ...
  #  plt.savefig('candlestick_chart.png') #new
    ...
    plt.legend()
  #  plt.savefig('stock_price_and_ma.png') #new
    plt.show()
    return long_name, current_price,
